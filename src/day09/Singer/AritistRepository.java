...
public class AritistRepository {
    ...
    public void addFirstArtist(String songName) {
    ...
    public void addNewSong(String songName, String name) {
        findArtistByName(String artistName, String songName)
